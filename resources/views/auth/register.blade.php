<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Type d'utilisateur -->
        <div class="mt-4">
            <x-input-label for="typeUser" :value="__('Type d\'utilisateur')" />
            <select name="typeUser" id="typeUser" class="block mt-1 w-full">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <!-- <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('register.parent') }}">
